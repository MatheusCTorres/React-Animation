...
import Planet1 from '../img/planet-earth.png'
import Planet2 from '../img/planet.png'
import Planet3 from '../img/planett.png'
import Planet4 from '../img/saturn.png'
            ...
            <Container>
                <ColumnLeft>
                    ...
                    <motion.p
                        ...
                        animate="visible"
                        transition={{duration:1}}
                    >Journey to the Intinity</motion.p>
                    <Button
                ...
                <ColumnRight>
                    <Image  src={Planet1} alt="planet" 
                        whileTap={{scale:0.9}}
                        drag={true}
                        dragConstraints={{left:0, top:0, right:250, bottom:50}}
